...
public class RegExUtils {
    ...
    public static boolean isAnyIndicatorsPresentInText(final String message,
        ...
        for (int i = 0; i < indicators.length; i++) {
            Pattern pattern = Pattern.compile(indicators[i], Pattern.CASE_INSENSITIVE);
    ...
    public static boolean isDatePresentInText(final String message) {
        ...
        /*
         * Pattern 1: DD-CCC-YYYY (23-MAR-2013) DD/CCC/YYYY (9/JUN/1987)
         * DD-CCC-YY (23-MAR-13) DD/CCC/YY (9/JUN/87)
         */
        ...
        /*
         * Pattern 2: DD/MM/YYYY (23-12-2113) DD-MM-YYYY (01-9-1913) DD/MM/YY
         * (23-12-13) DD-MM-YY (01-9-13)
         */
